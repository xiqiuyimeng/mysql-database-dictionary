...
from src.constant.constant import CONFIRM_TREE_HEADER_LABELS, COLLAPSE_BUTTON, \
    CANCEL_BUTTON, EXPAND_BUTTON, NEXT_GENERATE_BUTTON
...
class TreeWidgetUI:
    ...
    def setup_tree_ui(self):
        ...
        self.button_blank2 = QtWidgets.QLabel(self.widget)
        self.button_blank2.setObjectName("button_blank2")
        self.gridLayout_button.addWidget(self.button_blank2, 0, 2, 1, 1)
        self.next_button = QtWidgets.QPushButton(self.widget)
        self.next_button.setObjectName("next_button")
        self.gridLayout_button.addWidget(self.next_button, 0, 3, 1, 1)
        ...
        self.next_button.clicked.connect(self.parent.show_setting_dialog)
    ...
    def retranslateUi(self):
        ...
        self.next_button.setText(NEXT_GENERATE_BUTTON)
